				...
				<VStack spacing={8} textAlign='center' color='white'>
					...
					<MotionBox
						...
						<Text
							...
							lineHeight='1.6'
							mb={8}>
							Get viral predictions for your original tweets using the power of
							AI and real-time social data from{' '}
							<Link
							...
							. Analyze engagement potential, optimize for likes and replies,
						...
						<HStack spacing={6} justify='center' wrap='wrap'>
							{[
								...
								},
								{
									icon: FaHeart,
									title: 'AI Prediction',
									description: 'Predict likes and overall user engagement',
									color: '#E1306C',
								},
								{
									icon: FaShare,
