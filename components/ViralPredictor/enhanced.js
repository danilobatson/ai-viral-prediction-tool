        ...
        >
          <VStack spacing={6}>
            ...
            <SimpleGrid columns={{ base: 1, md: 3 }} spacing={4} w="full">
              ...
              <Stat bg="blue.50" p={4} borderRadius="lg" border="1px" borderColor="blue.200">
                ...
                <StatNumber color="blue.600">
                  {results.viralCategory || getViralCategory(results.viralProbability).label}
                </StatNumber>
              ...
              <Stat bg="green.50" p={4} borderRadius="lg" border="1px" borderColor="green.200">
                ...
                <StatNumber color="green.600">{results.confidenceScore}%</StatNumber>
            ...
            {results.recommendations && results.recommendations.length > 0 && (
              <Box w="full" bg="yellow.50" p={6} borderRadius="lg" border="1px" borderColor="yellow.200">
                <HStack spacing={3} mb={4}>
                  <Icon as={FaLightbulb} color="yellow.600" boxSize={5} />
                  <Heading size="sm" color="yellow.800">AI Optimization Suggestions</Heading>
                </HStack>
            ...
            <Box w="full" bg="gray.50" p={4} borderRadius="lg" border="1px" borderColor="gray.200">
              <Text fontSize="xs" color="gray.600" textAlign="center">
                Analysis powered by Google Gemini 2.0 Flash Lite • Real-time LunarCrush social data • 
                Zero mock data used • Results based on historical viral patterns
              </Text>
            </Box>
          </VStack>
        </MotionBox>
